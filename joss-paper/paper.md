...
Datashuttle will continue to evolve alongside the NeuroBlueprint specification, implementing upcoming extensions as they emerge. While datashuttle does not currently support a metadata standard, implementation of a simple, lightweight metadata schema for basic project documentation will be a key focus for future development. While full FAIR compliance is out of scope for NeuroBlueprint itself, datashuttle plans to facilitate transition toward more comprehensive schemas by supporting automated conversion of NeuroBlueprint projects to BIDS, including metadata conversion, alongside raw data file conversion to open formats such as NWB.
