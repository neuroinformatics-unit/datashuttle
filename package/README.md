...
The path handling is a little fiddly here, and some scripts are shared  between platform.
...
copy a few auxiliary files (e.g. license, Wezterm config)). Because we are building two Pyinstaller
...
3) `_vendored` is our vendor folder, that contains the vendored Wezterm terminal.
