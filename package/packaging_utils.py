...
def download_wezterm(vendored_dir: Path, wezterm_foldername: str) -> None:
    ...
    """
    vendored_dir : str = vendored_dir.as_posix()  # unfortunately we  need to do some Path / str juggling here
    ...
    if Path(wezterm_extracted_dir).exists():
        print(f"Not downloading Wezterm as it already exists at {wezterm_extracted_dir}.")
